...
await
Promise.all([check_youtube_premium(),check_netflix()])
.then((result) => {
console.log(result)
let disney_result=""
if (statusSTATUS_COMING) {
//console.log(1)
disney_result="Disney✢: 即将登陆~"+region.toUpperCase()
} else if (statusSTATUS_AVAILABLE){
//console.log(2)
console.log(region)
disney_result="Disney✢: 已经解锁 »» " +${getFlagEmoji(region)}   + region.toUpperCase()
// console.log(result["Disney"])
} else if (statusSTATUS_NOT_AVAILABLE) {
//console.log(3)
disney_result="Disney✢: 没有支持 🚫 "
} else if (statusSTATUS_TIMEOUT) {
